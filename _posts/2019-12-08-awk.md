...
你将会见到`/etc/passwd`文件的内容出现在眼前。现在，解释 awk 做了些什么。调用 awk 时，我们指定`/etc/passwd` 作为输入文件。执行 awk 时，它依次对`/etc/passwd` 中的每一行执行 `print` 命令。
...
![awk常用字符串函数1][p4-awk-常用字符串函数1]
![awk常用字符串函数2][p5-awk-常用字符串函数2]
...
[p1-awk分隔符示例]:/img/20191208-awk/awk-delimiter.jpg "awk分隔符示例"
[p2-awk-运算符]:/img/20191208-awk/awk-operator.jpg
[p3-awk-正则表达式]:/img/20191208-awk/awk-reg.jpg
[p4-awk-常用字符串函数1]:/img/20191208-awk/awk-string-func-1.jpg
[p5-awk-常用字符串函数2]:/img/20191208-awk/awk-string-func-2.jpg
[p1]:https://raw.githubusercontent.com/junqianghan/MarkDownResources/master/YouDaoNote/LearnNote/Tools/05-awk
